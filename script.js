...
Savatga qo'shish
            ...
            `;
             ...
             // 🔹 BUTTON CLICK
    let btn = div.querySelector(".korzinkaBtn");
...
//bu mani joyim korzinkania ki ismism  abdullloh 
function addToCart(product) {
    ...
    if (found) {
        ...
        cart.push({
            id: product.id,          // 🔴 MUHIM //<--- bu joyini chatdan oldim tan olaman faqt idninin
            name: product.name,
            price: product.price,
            image: product.image,
...
///// bu tugashi boldi boshqa kod yoq